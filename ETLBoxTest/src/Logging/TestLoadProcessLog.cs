...
namespace ALE.ETLBoxTest {
    ...
    public class TestLoadProcessLog {
        ...
        public void TestStartLoadProcessTaskWithMessage() {            
            ...
            Assert.AreEqual(1, new SqlTask("Check if load process messages are correct", $"select count(*) from etl.LoadProcess where StartMessage = 'Message 1' and Source='SourceA' and EndMessage is null and AbortMessage is null") { DisableLogging = true }.ExecuteScalar<int>());            
        }
