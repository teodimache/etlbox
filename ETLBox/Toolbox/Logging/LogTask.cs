namespace ALE.ETLBox {
    public class LogTask : GenericTask, ITask {
        ...
        public void Trace() => NLogger?.Trace(Message, TaskType, "LOG", TaskHash, ControlFlow.STAGE, ControlFlow.CurrentLoadProcess?.LoadProcessKey);
        public void Debug() => NLogger?.Debug(Message, TaskType, "LOG", TaskHash, ControlFlow.STAGE, ControlFlow.CurrentLoadProcess?.LoadProcessKey);
        ...
        public void Fatal() => NLogger?.Fatal(Message, TaskType, "LOG", TaskHash, ControlFlow.STAGE, ControlFlow.CurrentLoadProcess?.LoadProcessKey);
